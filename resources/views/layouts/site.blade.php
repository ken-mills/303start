...
<header id="top" class="top-image fill home text-center">
    <img src="{{asset('images/303startNoTag.png')}}" class="img-fluid img-rounded mx-auto d-block">
...
<div id="services" class="container-fluid bg-primary fill">
    ...
    <div class="row text-center" style="max-height: 20%">
        <div class="col-xs-12 col-sm-3">
            <img id="crelat1" src="images/connectgreen.jpg" class="img-fluid rounded-circle mx-auto d-block icon-303">
            <h4>relationships</h4>
            <div class="btn-spacing">
                <button id="btn1" class="btn btn-303 btn-secondary">learn more</button>
            </div>
        </div>
        <div class="col-xs-12 col-sm-3">
            <img id="csimple1" src="images/treeb.jpg" class="img-fluid rounded-circle mx-auto d-block icon-303">
            <h4>simplicity</h4>
            <div class="btn-spacing">
                <button id="btn2" class="btn btn-303 btn-secondary">learn more</button>
            </div>
        </div>
        <div class="col-xs-12 col-sm-3">
            <img id="cfun1" src="images/fireworkgreen.jpg" class="img-fluid rounded-circle mx-auto d-block icon-303">
            <h4>fun</h4>
            <div class="btn-spacing">
                <button id="btn3" class="btn btn-303 btn-secondary">learn more</button>
            </div>
        </div>
        <div class="col-xs-12 col-sm-3">
            <img id="cgears1" src="images/geargreen.jpg" class="img-fluid rounded-circle mx-auto d-block icon-303">
            <h4>customizable</h4>
            <div class="btn-spacing">
                <button id="btn4" class="btn btn-303 btn-secondary">learn more</button>
            </div>
        </div>
    </div>
    <!-- /.row (nested) -->
